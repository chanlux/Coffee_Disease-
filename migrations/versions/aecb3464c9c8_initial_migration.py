...
Revision ID: aecb3464c9c8
Revises: 
Create Date: 2026-09-08 00:57:16.542065
...
def upgrade():
    ...
    sa.Column('symptoms_selected', sa.Text(), nullable=True),
    sa.Column('diagnosis_result', sa.Text(), nullable=True),
    sa.Column('confidence_score', sa.Float(), nullable=True),
    sa.Column('disease_diagnosed', sa.String(length=100), nullable=True),
